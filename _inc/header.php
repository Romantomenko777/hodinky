    ...
    <div class="header-container">
      <nav class="navbar navbar-expand-sm navbar-light bg-light position-fixed container-fluid">
        <div class="container-fluid">
          ...
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navigacia"
            aria-controls="navigacia" aria-expanded="false" aria-label="Prepnúť navigáciu">
